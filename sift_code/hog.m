...
%img = imread('E:/compact/xml_toolbox/tests/VOC2011/train_images0331/2008_005473.jpg','jpg'); 

[M, N, K] = size(img);

img=imresize(img,[fix(M/(cellph*nblockh))*(cellph*nblockh) fix(N/(cellph*nblockh))*(cellph*nblockh)]);
[M, N, K] = size(img);
