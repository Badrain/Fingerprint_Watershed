...
LBP_feature_label = [ones(size(Positive_LBP_feature,1));-ones(size(Negative_LBP_feature,1))];
tic;
disp 'svmtraining:';
...
LBP_feature_label_test = [ones(size(Positive_LBP_feature,1));-ones(size(Negative_LBP_feature,1))];
